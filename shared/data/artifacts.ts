...
export const ARTIFACTS: Artifact[] = [
  {
    ...
    icon: '\uD83D\uDCD6', maxLevel: 20, costPerLevel: linear(20), effectPerLevel: 10,
  ...
  },
  {
    ...
    icon: '\uD83C\uDF40', maxLevel: 20, costPerLevel: linear(30), effectPerLevel: 5,
    effectType: 'dropRatePercent', effectUnit: '%',
  },
  {
    id: 'art_hp', name: '생명의 결정', description: 'HP 증가',
    icon: '\u2764\uFE0F', maxLevel: 20, costPerLevel: linear(15), effectPerLevel: 5,
    effectType: 'hpPercent', effectUnit: '%',
  },
  {
    id: 'art_mp', name: '마나의 결정', description: 'MP 증가',
    icon: '\uD83D\uDCA7', maxLevel: 20, costPerLevel: linear(15), effectPerLevel: 5,
    effectType: 'mpPercent', effectUnit: '%',
  },
  {
    id: 'art_atk', name: '파괴의 룬', description: '공격력 증가',
    icon: '\u2694\uFE0F', maxLevel: 20, costPerLevel: linear(25), effectPerLevel: 3,
  ...
  },
  {
    ...
    icon: '\uD83D\uDC8E', maxLevel: 20, costPerLevel: linear(30), effectPerLevel: 10,
