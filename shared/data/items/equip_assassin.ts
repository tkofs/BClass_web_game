...
export const EQUIP_ASSASSIN: Item[] = [
  // --- Common (일반) ---
  {
    id: 'as_cmn_dagger_01', name: '낡은 뼈갈개', description: '골목길 불량배들이 주로 쓰는 녹슨 단검입니다.',
  ...
  {
    id: 'as_cmn_sword_01', name: '뒷골목 쾌검', description: '휘두르기 편하게 날을 짧게 깎은 도검입니다.',
  ...
  {
    id: 'as_cmn_chest_01', name: '빛바랜 가죽 튜닉', description: '어둠 속에 섞이기 좋은 검고 낡은 가죽옷입니다.',
    type: 'chest', rarity: 'common', iconUrl: '/assets/items/inv_chest_leather_01.svg',
    stackable: false, maxStack: 1, sellPrice: 6, requiredClass: 'assassin',
    stats: { defense: 15, hp: 10 }
  },
  {
    id: 'as_cmn_legs_01', name: '헤진 가죽 바지', description: '다리의 움직임을 방해하지 않는 가죽 바지입니다.',
    type: 'legs', rarity: 'common', iconUrl: '/assets/items/inv_pants_leather_01.svg',
    stackable: false, maxStack: 1, sellPrice: 5, requiredClass: 'assassin',
    stats: { defense: 12, hp: 8 }
  },
  {
    id: 'as_cmn_boots_01', name: '발소리 없는 장화', description: '밑창에 푹신한 헝겊을 덧대어 발소리를 죽였습니다.',
  ...
  {
    id: 'as_cmn_helm_01', name: '가죽 안대', description: '한쪽 눈을 가려 어둠에 빨리 적응하도록 돕습니다.',
    type: 'helm', rarity: 'common', iconUrl: '/assets/items/inv_helmet_19.svg',
    stackable: false, maxStack: 1, sellPrice: 4, requiredClass: 'assassin',
    stats: { defense: 8, hp: 5 }
  },
  {
    id: 'as_cmn_gloves_01', name: '소매치기의 장갑', description: '손가락 끝부분이 뚫려 있어 미세한 작업에 유리합니다.',
  ...
  {
    id: 'as_cmn_shoulders_01', name: '얇은 가죽 어깨보호대', description: '최소한의 방호력만 갖춘 어깨 덧대입니다.',
    type: 'shoulders', rarity: 'common', iconUrl: '/assets/items/inv_shoulder_17.svg',
    stackable: false, maxStack: 1, sellPrice: 4, requiredClass: 'assassin',
    stats: { defense: 10, hp: 6 }
  },
  {
    id: 'as_cmn_belt_01', name: '단검 꽂이 허리띠', description: '단검이나 투척 무기를 숨기기 좋은 허리띠입니다.',
  ...
  {
    id: 'as_cmn_throw_01', name: '조잡한 투척 단검', description: '도망치는 적의 발목을 잡기 위해 던지는 무기입니다.',
  ...
  // --- Uncommon (고급) ---
  {
    id: 'as_unc_dagger_01', name: '톱니날 절단기', description: '상처를 찢어발기기 위해 날을 톱니처럼 세운 단검입니다.',
  ...
  {
    id: 'as_unc_sword_01', name: '지옥무쇠 쾌검', description: '가볍고 예리하게 벼려진 지옥무쇠 한손검입니다.',
  ...
  {
    id: 'as_unc_chest_01', name: '톱니매듭 가죽 튜닉', description: '톱니매듭 가죽으로 만들어져 튼튼하고 질깁니다.',
  ...
  {
    id: 'as_unc_legs_01', name: '톱니매듭 바지', description: '도적들의 민첩한 움직임을 완벽하게 지원합니다.',
    type: 'legs', rarity: 'uncommon', iconUrl: '/assets/items/inv_pants_leather_02.svg',
    stackable: false, maxStack: 1, sellPrice: 140, requiredClass: 'assassin',
    stats: { defense: 30, hp: 25, attack: 8 }
  },
  {
    id: 'as_unc_helm_01', name: '톱니매듭 복면', description: '입과 코를 가려 정체를 숨겨주는 복면입니다.',
  ...
  {
    id: 'as_unc_boots_01', name: '톱니매듭 장화', description: '아웃랜드 척박한 지형에서도 발을 보호해 줍니다.',
  ...
  {
    id: 'as_unc_shoulders_01', name: '톱니매듭 어깨보호대', description: '어깨 관절의 움직임을 자유롭게 해줍니다.',
  ...
  {
    id: 'as_unc_fist_01', name: '가시박힌 쇳조각', description: '주먹에 끼우고 휘두르면 치명적인 타격을 입힙니다.',
  ...
  {
    id: 'as_unc_mace_01', name: '도적의 둔기', description: '적의 뒤통수를 내리쳐 기절시킬 때 씁니다.',
    type: 'weapon', rarity: 'uncommon', iconUrl: '/assets/items/inv_mace_09.svg',
    stackable: false, maxStack: 1, sellPrice: 120, requiredClass: 'assassin',
    stats: { attack: 45, critDamage: 0.1 }
  },
  {
    id: 'as_unc_accessory_01', name: '독이 든 약병', description: '언제든 무기에 바를 수 있도록 준비해둔 맹독입니다.',
  ...
  // --- Rare (희귀) ---
  {
    id: 'as_rar_dagger_01', name: '은빛별 단검', description: '은은한 달빛 아래서 번뜩이는 날카로운 비수입니다.',
  ...
  {
    id: 'as_rar_sword_01', name: '라트로의 변화하는 검', description: '어둠의 미궁에서 수많은 도적들이 갈망하던 국민 도검입니다.',
  ...
  {
    id: 'as_rar_boots_01', name: '고요한 발걸음의 장화', description: '그림자 속을 걷는 자들을 위한 암살의 필수품입니다.',
  ...
  {
    id: 'as_rar_accessory_01', name: '해체자의 모래시계', description: '공격 시 일정 확률로 민첩성을 폭발적으로 증가시키는 장신구입니다.',
  ...
  {
    id: 'as_rar_throw_01', name: '칼날비늘 투척 단검', description: '칼날산맥의 비룡 비늘을 갈아 만든 날카로운 투척 무기입니다.',
  ...
  // --- Epic (영웅) ---
  {
    id: 'as_epc_dagger_01', name: '말차진', description: '카라잔 공작 말체자르가 드랍하는 무시무시한 에픽 단검입니다.',
  ...
  {
    id: 'as_epc_sword_01', name: '증오의 일격', description: '카라잔 일루시아가 드랍하며, 도적들에게 매우 인기가 많은 도검입니다.',
  ...
  {
    id: 'as_epc_fist_01', name: '아즈샤라의 발톱', description: '눈먼 군주 레오테라스가 떨어뜨리는 치명적인 장착 무기입니다.',
  ...
  {
    id: 'as_epc_chest_01', name: '죽음의 선고자 튜닉', description: '도적 티어 5 세트, 적에게 죽음을 선고하는 자의 흉갑입니다.',
  ...
  {
    id: 'as_epc_legs_01', name: '학살자의 다리보호구', description: '도적 티어 6 세트, 오직 살육을 위해 맞춰진 바지입니다.',
  ...
  {
    id: 'as_epc_helm_01', name: '학살자의 복면', description: '도적 티어 6 세트, 피비린내 나는 학살자의 검은 복면입니다.',
  ...
  {
    id: 'as_epc_shoulders_01', name: '죽음의 선고자 어깨구장', description: '도적 티어 5 세트, 해골 장식이 돋보이는 어깨 방어구입니다.',
  ...
  {
    id: 'as_epc_boots_01', name: '그림자 밟기 장화', description: '적의 배후로 순식간에 이동할 수 있도록 돕는 마법의 장화입니다.',
  ...
  {
    id: 'as_epc_accessory_01', name: '배반자의 광기', description: '검은 사원에서 드랍되는, 방어구 관통과 전투력을 극대화하는 장신구입니다.',
  ...
  {
    id: 'as_epc_throw_01', name: '죽음의 깃털', description: '투척용 무기로는 최고 수준의 예리함을 자랑합니다.',
