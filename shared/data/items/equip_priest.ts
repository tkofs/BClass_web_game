...
export const EQUIP_PRIEST: Item[] = [
  // --- Common (일반) ---
  {
    id: 'pr_cmn_mace_01', name: '수습생의 철퇴', description: '기본적인 호신용 철퇴입니다.',
  ...
  {
    id: 'pr_cmn_wand_01', name: '나무 마술봉', description: '약한 빛을 내뿜는 평범한 마술봉입니다.',
  ...
  {
    id: 'pr_cmn_robe_01', name: '수녀원 로브', description: '수도원에서 지급하는 정갈하고 깨끗한 로브입니다.',
  ...
  {
    id: 'pr_cmn_pants_01', name: '수녀원 바지', description: '기도를 올리기 편하게 통이 넓은 바지입니다.',
    type: 'legs', rarity: 'common', iconUrl: '/assets/items/inv_pants_cloth_05.svg',
    stackable: false, maxStack: 1, sellPrice: 5, requiredClass: 'priest',
    stats: { defense: 8, hp: 10 }
  },
  {
    id: 'pr_cmn_shoes_01', name: '가벼운 샌들', description: '수도원의 정숙함을 유지해주는 굽 낮은 샌들입니다.',
    type: 'boots', rarity: 'common', iconUrl: '/assets/items/inv_boots_cloth_04.svg',
    stackable: false, maxStack: 1, sellPrice: 4, requiredClass: 'priest',
    stats: { defense: 6, hp: 8 }
  },
  {
    id: 'pr_cmn_cowl_01', name: '수습생 두건', description: '기도할 때 시야를 차단하여 집중을 돕는 얇은 두건입니다.',
    type: 'helm', rarity: 'common', iconUrl: '/assets/items/inv_helmet_14.svg',
    stackable: false, maxStack: 1, sellPrice: 5, requiredClass: 'priest',
    stats: { defense: 7, hp: 8 }
  },
  {
    id: 'pr_cmn_gloves_01', name: '흰색 헝겊 장갑', description: '부상자를 치료할 때 손을 청결하게 유지해줍니다.',
  ...
  {
    id: 'pr_cmn_shoulders_01', name: '수녀원 어깨걸이', description: '어깨를 살짝 덮는 깨끗한 천 조각입니다.',
    type: 'shoulders', rarity: 'common', iconUrl: '/assets/items/inv_shoulder_13.svg',
    stackable: false, maxStack: 1, sellPrice: 4, requiredClass: 'priest',
    stats: { defense: 6, hp: 7 }
  },
  {
    id: 'pr_cmn_belt_01', name: '꼬인 밧줄 허리띠', description: '로브를 고정하기 위해 묶는 단순한 밧줄입니다.',
  ...
  {
    id: 'pr_cmn_staff_01', name: '순례자의 떡갈나무 지팡이', description: '여행하는 사제들의 지친 다리를 지탱해주는 지팡이입니다.',
  ...
  // --- Uncommon (고급) ---
  {
    id: 'pr_unc_mace_01', name: '치유사의 철퇴', description: '성스러운 기운이 은은하게 감도는 철퇴입니다.',
  ...
  {
    id: 'pr_unc_wand_01', name: '은빛마루 마술봉', description: '어둠을 밝히는 순백의 빛을 발사하는 마술봉입니다.',
  ...
  {
    id: 'pr_unc_robe_01', name: '축복받은 비단 로브', description: '부드러운 비단으로 짜여져 신성력을 증폭시킵니다.',
  ...
  {
    id: 'pr_unc_pants_01', name: '축복받은 비단 바지', description: '성스러운 기운이 다리를 가볍게 해줍니다.',
    type: 'legs', rarity: 'uncommon', iconUrl: '/assets/items/inv_pants_cloth_06.svg',
    stackable: false, maxStack: 1, sellPrice: 140, requiredClass: 'priest',
    stats: { defense: 22, hp: 20, attack: 12 }
  },
  {
    id: 'pr_unc_cowl_01', name: '신성한 두건', description: '치유 주문에 대한 집중력을 크게 높여주는 두건입니다.',
  ...
  {
    id: 'pr_unc_shoes_01', name: '비단 덧신', description: '긴 순례길에 적합하게 밑창을 덧댄 비단 신발입니다.',
  ...
  {
    id: 'pr_unc_shoulders_01', name: '비단 어깨보호대', description: '단정한 십자 문양이 새겨져 있습니다.',
  ...
  {
    id: 'pr_unc_gloves_01', name: '비단 치유 장갑', description: '치유의 손길을 더욱 부드럽게 전할 수 있습니다.',
  ...
  {
    id: 'pr_unc_dagger_01', name: '의식용 은단검', description: '성수나 마도구의 불순물을 제거할 때 쓰는 단검입니다.',
  ...
  {
    id: 'pr_unc_offhand_01', name: '고대의 기도서', description: '여러 성스러운 고대 기도문이 빼곡히 적힌 책입니다.',
  ...
  // --- Rare (희귀) ---
  {
    id: 'pr_rar_staff_01', name: '구원의 지팡이', description: '아우킨둔에서 발견된 영혼을 구제하는 치유의 지팡이입니다.',
  ...
  {
    id: 'pr_rar_wand_01', name: '정화의 마술봉', description: '타락한 기운을 씻어내는 성스러운 마술봉입니다.',
  ...
  {
    id: 'pr_rar_mace_01', name: '성광의 망치', description: '악을 내리치고 아군을 치유하는 다목적 무기입니다.',
  ...
  {
    id: 'pr_rar_offhand_01', name: '빛나는 정령의 파편', description: '나루의 힘이 희미하게 남아있는 신성한 보석입니다.',
  ...
  {
    id: 'pr_rar_accessory_01', name: '치유사의 은빛 브로치', description: '위급한 순간 폭발적인 생명력을 불어넣는 장신구입니다.',
  ...
  {
    id: 'pr_rar_shoulders_01', name: '수호성인의 어깨보호대', description: '성스러운 기운으로 어깨를 따뜻하게 감싸줍니다.',
  ...
  // --- Epic (영웅) ---
  {
    id: 'pr_epc_mace_01', name: '빛의 정의', description: '카라잔의 공작 말체자르가 드랍하는 눈부신 치유의 철퇴입니다.',
  ...
  {
    id: 'pr_epc_staff_01', name: '완전한 회복의 지팡이', description: '검은 사원에서 획득할 수 있는, 아군을 죽음에서 되돌리는 지팡이입니다.',
  ...
  {
    id: 'pr_epc_wand_01', name: '나루의 생명력', description: '샤트라스 나루의 정수가 직접 담긴 에픽 마술봉입니다.',
  ...
  {
    id: 'pr_epc_robe_01', name: '화신의 의복', description: '사제 티어 5 세트의 눈부시게 빛나는 성스러운 가슴 방어구입니다.',
  ...
  {
    id: 'pr_epc_pants_01', name: '사면의 다리보호구', description: '사제 티어 6 세트의 고결한 다리 방어구입니다.',
  ...
  {
    id: 'pr_epc_cowl_01', name: '화신의 두건', description: '사제 티어 5 세트, 머리 뒤로 황금빛 후광이 비치는 두건입니다.',
  ...
  {
    id: 'pr_epc_shoulders_01', name: '사면의 어깨구장', description: '사제 티어 6 세트, 눈먼 천사의 형상이 조각된 어깨 방어구입니다.',
  ...
  {
    id: 'pr_epc_offhand_01', name: '축복받은 치유의 서', description: '생명 마법의 극의가 담겨있는 보조 장비 마도서입니다.',
  ...
  {
    id: 'pr_epc_accessory_01', name: '므루의 눈물', description: '타락한 나루 므루가 남긴 마지막 빛방울로, 엄청난 마나 회복을 돕습니다.',
  ...
  {
    id: 'pr_epc_gloves_01', name: '화신의 장갑', description: '손짓 한 번으로 빈사 상태의 아군을 일으켜 세우는 장갑입니다.',
