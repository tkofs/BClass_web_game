...
export const EQUIP_SHADOW_MAGE: Item[] = [
  // --- Common (일반) ---
  {
    id: 'sm_cmn_staff_01', name: '수습생의 나무 지팡이', description: '기초적인 마나 집중을 돕는 평범한 지팡이입니다.',
  ...
  {
    id: 'sm_cmn_wand_01', name: '희미한 마술봉', description: '미약한 마력의 빛을 내뿜는 낡은 마술봉입니다.',
  ...
  {
    id: 'sm_cmn_robe_01', name: '수습생의 로브', description: '마법사 길드에서 지급하는 얇은 천 로브입니다.',
  ...
  {
    id: 'sm_cmn_pants_01', name: '수습생의 바지', description: '움직임이 편한 부드러운 천 바지입니다.',
    type: 'legs', rarity: 'common', iconUrl: '/assets/items/inv_pants_cloth_01.svg',
    stackable: false, maxStack: 1, sellPrice: 5, requiredClass: 'shadow_mage',
    stats: { defense: 8, hp: 8 }
  },
  {
    id: 'sm_cmn_shoes_01', name: '수습생의 덧신', description: '발소리를 죽여주는 가벼운 천 신발입니다.',
    type: 'boots', rarity: 'common', iconUrl: '/assets/items/inv_boots_cloth_01.svg',
    stackable: false, maxStack: 1, sellPrice: 4, requiredClass: 'shadow_mage',
    stats: { defense: 6, hp: 5 }
  },
  {
    id: 'sm_cmn_cowl_01', name: '허름한 두건', description: '얼굴을 반쯤 가려주는 평범한 천 두건입니다.',
    type: 'helm', rarity: 'common', iconUrl: '/assets/items/inv_helmet_09.svg',
    stackable: false, maxStack: 1, sellPrice: 5, requiredClass: 'shadow_mage',
    stats: { defense: 7, hp: 6 }
  },
  {
    id: 'sm_cmn_gloves_01', name: '얇은 천 장갑', description: '손끝의 감각을 유지해주는 마법사용 장갑입니다.',
  ...
  {
    id: 'sm_cmn_shoulders_01', name: '낡은 어깨걸이', description: '보온 효과 정도만 기대할 수 있는 어깨걸이입니다.',
    type: 'shoulders', rarity: 'common', iconUrl: '/assets/items/inv_shoulder_09.svg',
    stackable: false, maxStack: 1, sellPrice: 4, requiredClass: 'shadow_mage',
    stats: { defense: 6, hp: 5 }
  },
  {
    id: 'sm_cmn_belt_01', name: '천 허리띠', description: '로브를 고정하기 위해 묶는 천 조각입니다.',
  ...
  {
    id: 'sm_cmn_dagger_01', name: '무딘 의식용 단검', description: '마법진을 그릴 때 쓰던 무딘 단검입니다.',
  ...
  // --- Uncommon (고급) ---
  {
    id: 'sm_unc_staff_01', name: '테로카르 숲 수정 지팡이', description: '테로카르 숲의 마력이 깃든 수정을 가공한 지팡이입니다.',
  ...
  {
    id: 'sm_unc_dagger_01', name: '마력 깃든 희생의 단검', description: '어두운 의식에 사용된 흔적이 있는 단검입니다.',
  ...
  {
    id: 'sm_unc_offhand_01', name: '어둠의 기록서', description: '알 수 없는 언어로 적힌 불길한 마도서입니다.',
  ...
  // --- Rare (희귀) ---
  {
    id: 'sm_rar_staff_01', name: '암흑 불길의 지팡이', description: '마나 무덤에서 발견된 검은 불꽃을 내뿜는 지팡이입니다.',
  ...
  {
    id: 'sm_rar_wand_01', name: '공허의 마술봉', description: '공허의 에너지를 발사하는 치명적인 마술봉입니다.',
  ...
  {
    id: 'sm_rar_robe_01', name: '마력 깃든 암흑매듭 로브', description: '암흑 사제와 마법사들이 탐내는 재봉술의 걸작입니다.',
  ...
  {
    id: 'sm_rar_pants_01', name: '마력 깃든 암흑매듭 바지', description: '암흑 마법의 위력을 한층 끌어올려 줍니다.',
    type: 'legs', rarity: 'rare', iconUrl: '/assets/items/inv_pants_cloth_03.svg',
    stackable: false, maxStack: 1, sellPrice: 850, requiredClass: 'shadow_mage',
    stats: { defense: 40, hp: 35, attack: 45, critRate: 0.03 }
  },
  {
    id: 'sm_rar_cowl_01', name: '마력 깃든 암흑매듭 복면', description: '착용자의 눈빛마저 어둡게 물들이는 복면입니다.',
  ...
  {
    id: 'sm_rar_shoes_01', name: '마력 깃든 암흑매듭 장화', description: '그림자 속을 걷는 듯한 착각을 불러일으킵니다.',
  ...
  {
    id: 'sm_rar_sword_01', name: '연속타격의 검', description: '한 손 마법검사들이 선호하는 날렵한 마력검입니다.',
  ...
  {
    id: 'sm_rar_offhand_01', name: '그림자 해골', description: '흑마술의 매개체로 사용되는 불길한 해골입니다.',
  ...
  {
    id: 'sm_rar_accessory_01', name: '은빛초승달의 상징', description: '영웅 던전 휘장으로 구매할 수 있는 마법사들의 필수 장신구입니다.',
  ...
  {
    id: 'sm_rar_shoulders_01', name: '붉은학살자의 어깨보호대', description: '잔혹한 학살자의 기운이 서린 천 어깨방어구입니다.',
  ...
  // --- Epic (영웅) ---
  {
    id: 'sm_epc_sword_01', name: '나스레짐의 흡혈검', description: '공작 말체자르가 드랍하는, 암흑 마법사에게 최적화된 마법검입니다.',
  ...
  {
    id: 'sm_epc_staff_01', name: '자르둠 - 포식자의 지팡이', description: '일리단 스톰레이지가 드랍하는 끔찍한 지옥견 모양의 지팡이입니다.',
  ...
  {
    id: 'sm_epc_wand_01', name: '잊혀진 별', description: '폭풍우 요새에서 획득 가능한 에픽 마술봉입니다.',
  ...
  {
    id: 'sm_epc_robe_01', name: '티리스팔의 흉갑', description: '마법사 티어 5 세트의 위엄 넘치는 가슴 방어구입니다.',
  ...
  {
    id: 'sm_epc_pants_01', name: '폭풍우 다리보호구', description: '마법사 티어 6 세트의 마력 증폭 다리 방어구입니다.',
  ...
  {
    id: 'sm_epc_cowl_01', name: '티리스팔의 두건', description: '마법사 티어 5 세트의 두건으로, 심연의 지혜를 담고 있습니다.',
  ...
  {
    id: 'sm_epc_shoulders_01', name: '폭풍우 어깨보호대', description: '마법사 티어 6 세트의 번개 문양이 새겨진 어깨 방어구입니다.',
  ...
  {
    id: 'sm_epc_offhand_01', name: '심판관의 영혼책', description: '어둠의 심판을 내릴 때 사용하는 보조 장비 마도서입니다.',
  ...
  {
    id: 'sm_epc_accessory_01', name: '굴단의 해골', description: '일리단이 쥐고 있던 장신구로, 사용 시 압도적인 마법 가속을 부여합니다.',
  ...
  {
    id: 'sm_epc_gloves_01', name: '티리스팔의 장갑', description: '손에서 검은 불꽃이 피어오르는 에픽 장갑입니다.',
