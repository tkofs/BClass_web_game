...
export const EQUIP_HUNTER: Item[] = [
  // --- Common (일반) ---
  {
    id: 'hn_cmn_bow_01', name: '사냥꾼의 나무 활', description: '기본적인 사냥용 나무 활입니다.',
  ...
  {
    id: 'hn_cmn_gun_01', name: '조잡한 나팔총', description: '소리만 요란하고 위력은 그저 그런 화승총입니다.',
  ...
  {
    id: 'hn_cmn_chest_01', name: '사냥꾼의 낡은 사슬 흉갑', description: '초보 사냥꾼에게 지급되는 가벼운 사슬 갑옷입니다.',
  ...
  {
    id: 'hn_cmn_legs_01', name: '징집병의 사슬 다리보호구', description: '활동성을 고려해 만들어진 다리보호구입니다.',
  ...
  {
    id: 'hn_cmn_helm_01', name: '야영지 사슬 두건', description: '바람을 막아주는 얇은 사슬 두건입니다.',
    type: 'helm', rarity: 'common', iconUrl: '/assets/items/inv_helmet_05.svg',
    stackable: false, maxStack: 1, sellPrice: 6, requiredClass: 'hunter',
    stats: { defense: 18, hp: 10 }
  },
  {
    id: 'hn_cmn_boots_01', name: '튼튼한 사냥 장화', description: '장거리 추적에 적합하게 밑창을 보강했습니다.',
    type: 'boots', rarity: 'common', iconUrl: '/assets/items/inv_boots_chain_01.svg',
    stackable: false, maxStack: 1, sellPrice: 5, requiredClass: 'hunter',
    stats: { defense: 15, hp: 8 }
  },
  {
    id: 'hn_cmn_gloves_01', name: '궁수의 가죽장갑', description: '활시위를 당길 때 손가락을 보호해 줍니다.',
  ...
  {
    id: 'hn_cmn_shoulders_01', name: '녹슨 사슬 어깨보호대', description: '관리가 덜 되어 녹이 슨 방어구입니다.',
    type: 'shoulders', rarity: 'common', iconUrl: '/assets/items/inv_shoulder_05.svg',
    stackable: false, maxStack: 1, sellPrice: 5, requiredClass: 'hunter',
    stats: { defense: 16, hp: 8 }
  },
  {
    id: 'hn_cmn_belt_01', name: '사냥꾼의 탄띠', description: '총알이나 화살을 꽂아둘 수 있는 허리띠입니다.',
  ...
  {
    id: 'hn_cmn_axe_01', name: '벌목용 손도끼', description: '근접전이 벌어졌을 때 호신용으로 쓰는 작은 도끼입니다.',
  ...
  // --- Uncommon (고급) ---
  {
    id: 'hn_unc_bow_01', name: '테로카르 굽은활', description: '테로카르 숲의 질긴 나무로 만든 굽은활입니다.',
  ...
  {
    id: 'hn_unc_gun_01', name: '지옥무쇠 머스킷총', description: '지옥무쇠로 총열을 강화한 튼튼한 총입니다.',
  ...
  {
    id: 'hn_unc_chest_01', name: '장가르비늘 흉갑', description: '늪지대 생물의 비늘을 엮어 만든 사슬 갑옷입니다.',
  ...
  {
    id: 'hn_unc_legs_01', name: '지옥무쇠 사슬 다리보호구', description: '아웃랜드 초반 사냥꾼들의 든든한 다리 방어구입니다.',
    type: 'legs', rarity: 'uncommon', iconUrl: '/assets/items/inv_pants_chain_02.svg',
    stackable: false, maxStack: 1, sellPrice: 160, requiredClass: 'hunter',
    stats: { defense: 40, hp: 35 }
  },
  {
    id: 'hn_unc_helm_01', name: '추적자의 사슬 두건', description: '사냥감을 추적할 때 주변 환경과 동화되도록 돕습니다.',
  ...
  {
    id: 'hn_unc_boots_01', name: '나그란드 배회자의 장화', description: '발소리를 죽여주는 특수 사슬 장화입니다.',
  ...
  {
    id: 'hn_unc_shoulders_01', name: '칼날산맥 순찰자의 어깨보호대', description: '날카로운 바위로부터 어깨를 보호합니다.',
  ...
  {
    id: 'hn_unc_belt_01', name: '매의 눈 요대', description: '멀리 볼 수 있는 집중력을 기르는데 도움을 줍니다.',
  ...
  {
    id: 'hn_unc_polearm_01', name: '갈가마귀 창', description: '야수들이 접근했을 때 거리를 벌리기 좋은 미늘창입니다.',
  ...
  {
    id: 'hn_unc_accessory_01', name: '사냥꾼의 부적', description: '야수의 영혼이 깃든 작은 뼈 부적입니다.',
  ...
  // --- Rare (희귀) ---
  {
    id: 'hn_rar_bow_01', name: '발라노스의 장궁', description: '아웃랜드 희귀몹 발라노스가 떨어뜨리는 훌륭한 장궁입니다.',
  ...
  {
    id: 'hn_rar_gun_01', name: '군단의 파멸', description: '어둠의 미궁에서 악마들을 꿰뚫던 강력한 총입니다.',
  ...
  {
    id: 'hn_rar_polearm_01', name: '음속의 창', description: '어둠의 미궁 무르무르가 드랍하는 사냥꾼의 국민 미늘창입니다.',
  ...
  {
    id: 'hn_rar_shoulders_01', name: '황무지 방랑자의 견갑', description: '버섯구름 봉우리를 떠돌던 방랑자의 유품입니다.',
  ...
  {
    id: 'hn_rar_gloves_01', name: '정밀한 조준의 장갑', description: '원거리 무기의 적중률을 크게 높여주는 장갑입니다.',
  ...
  {
    id: 'hn_rar_sword_01', name: '별빛 단검', description: '쌍수 사냥꾼들이 주로 사용하는 날카로운 단검입니다.',
  ...
  {
    id: 'hn_rar_accessory_01', name: '피의 욕망 브로치', description: '카라잔 입장 전 필수 장신구 중 하나입니다.',
  ...
  // --- Epic (영웅) ---
  {
    id: 'hn_epc_bow_01', name: '태양격노 불사조의 활', description: '카라잔 공작 말체자르가 드랍하는 아름다운 명궁입니다.',
  ...
  {
    id: 'hn_epc_gun_01', name: '늑대잡이 저격총', description: '카라잔 오페라 극장에서 드랍되는 외형이 멋진 저격총입니다.',
  ...
  {
    id: 'hn_epc_chest_01', name: '악마추적자 흉갑', description: '사냥꾼 티어 4 세트의 가슴 방어구입니다.',
  ...
  {
    id: 'hn_epc_legs_01', name: '균열추적자 다리보호대', description: '사냥꾼 티어 5 세트의 다리 방어구입니다.',
  ...
  {
    id: 'hn_epc_helm_01', name: '그론추적자 투구', description: '눈에서 안광이 뿜어져 나오는 사냥꾼 티어 6 투구입니다.',
  ...
  {
    id: 'hn_epc_shoulders_01', name: '그론추적자 어깨갑옷', description: '사냥꾼 티어 6 세트의 눈알 장식 어깨 방어구입니다.',
  ...
  {
    id: 'hn_epc_polearm_01', name: '지옥무장 창', description: '폭풍우 요새에서 획득하는 근접 전투용 에픽 창입니다.',
  ...
  {
    id: 'hn_epc_sword_01', name: '황천의 파멸', description: '폭풍우 요새 알라르가 드랍하며, 쌍수 사냥꾼에게 매우 좋습니다.',
  ...
  {
    id: 'hn_epc_crossbow_01', name: '배반자의 검은활', description: '검은 사원의 일리단이 드랍하는 최고급 활(석궁 판정)입니다.',
  ...
  {
    id: 'hn_epc_accessory_01', name: '용의 뼈 전리품', description: '그룰이 드랍하는, 공격 속도를 비약적으로 높여주는 장신구입니다.',
