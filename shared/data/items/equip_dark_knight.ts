...
export const EQUIP_DARK_KNIGHT: Item[] = [
  // --- Common (일반) ---
  {
    id: 'dk_cmn_sword_01', name: '회색빛 야영지 장검', description: '기본적인 철제 장검입니다.',
  ...
  {
    id: 'dk_cmn_axe_01', name: '녹슨 지옥절단기 도끼', description: '버려진 지옥절단기의 파편으로 만든 도끼입니다.',
  ...
  {
    id: 'dk_cmn_shield_01', name: '금이 간 아웃랜드 방패', description: '방어용으로 쓰기엔 조금 부실해 보입니다.',
  ...
  {
    id: 'dk_cmn_chest_01', name: '징집병의 판금 흉갑', description: '명예의 요새 징집병들에게 지급되는 흉갑입니다.',
  ...
  {
    id: 'dk_cmn_legs_01', name: '징집병의 판금 다리갑옷', description: '기본적인 방호력을 제공합니다.',
  ...
  {
    id: 'dk_unc_mace_01', name: '테로카르 망치', description: '테로카르 숲에서 흔히 볼 수 있는 무기입니다.',
  ...
  {
    id: 'dk_unc_axe_01', name: '장가르 나무꾼의 도끼', description: '거대한 버섯을 벨 때 쓰던 도끼입니다.',
  ...
  {
    id: 'dk_unc_shoulders_01', name: '아웃랜드 수호자의 견갑', description: '수호자들에게 지급되는 제식 견갑입니다.',
  ...
  {
    id: 'dk_unc_belt_01', name: '칼날산맥의 판금 요대', description: '칼날산맥의 오우거들이 차고 다니던 요대입니다.',
  ...
  // --- Rare (희귀) ---
  {
    id: 'dk_rar_sword_01', name: '라트로의 춤추는 검', description: '어둠의 미궁에서 드랍되는 전사들의 훌륭한 초반 한손검입니다.',
  ...
  {
    id: 'dk_rar_shield_01', name: '명예의 문장 방패', description: '부서진 전당에서 획득 가능한 방어 전사용 방패입니다.',
  ...
  {
    id: 'dk_rar_chest_01', name: '정의의 흉갑', description: '정의를 수호하는 자들을 위한 흉갑입니다.',
  ...
  {
    id: 'dk_rar_legs_01', name: '거침없는 힘의 다리갑옷', description: '물리적인 충격을 훌륭하게 흡수합니다.',
  ...
  {
    id: 'dk_rar_helm_01', name: '투시력의 판금 투구', description: '전장의 흐름을 꿰뚫어 볼 수 있게 해줍니다.',
  ...
  {
    id: 'dk_rar_mace_01', name: '무자비한 자의 철퇴', description: '적의 방어구를 부수는데 특화된 철퇴입니다.',
  ...
  {
    id: 'dk_rar_axe_01', name: '공허의 발톱', description: '황천의 에너지가 서려 있는 날카로운 도끼입니다.',
  ...
  {
    id: 'dk_rar_accessory_01', name: '아다만타이트 조각상', description: '전사들의 생존력을 올려주는 장신구입니다.',
  ...
  {
    id: 'dk_rar_shoulders_01', name: '용기병의 견갑', description: '용기병의 비늘로 만들어져 매우 단단합니다.',
  ...
  {
    id: 'dk_rar_belt_01', name: '굳건한 수호자의 허리띠', description: '어떤 공격에도 흔들리지 않게 잡아줍니다.',
  ...
  // --- Epic (영웅) ---
  {
    id: 'dk_epc_sword_01', name: '우박가시', description: '카라잔 일루시아가 드랍하는 치명적인 검입니다.',
  ...
  {
    id: 'dk_epc_sword_02', name: '사자심장 처형검', description: '대장기술로 제작할 수 있는 강력한 양손검입니다.',
  ...
  {
    id: 'dk_epc_shield_01', name: '알도르의 유산 방패', description: '그룰의 둥지에서 획득 가능한 방패입니다.',
  ...
  {
    id: 'dk_epc_chest_01', name: '파괴자의 흉갑', description: '전사 티어 5 (파괴자) 세트의 가슴 방어구입니다.',
  ...
  {
    id: 'dk_epc_legs_01', name: '맹공의 다리갑옷', description: '전사 티어 6 (맹공) 세트의 다리 방어구입니다.',
  ...
  {
    id: 'dk_epc_helm_01', name: '맹공의 위대한 투구', description: '전사 티어 6 (맹공) 세트의 투구입니다.',
  ...
  {
    id: 'dk_epc_axe_01', name: '황천의 파멸', description: '폭풍우 요새 알라르가 드랍하는 한손 도끼입니다.',
  ...
  {
    id: 'dk_epc_mace_01', name: '스톰헤럴드', description: '대장기술의 정점, 상대를 기절시키는 양손 철퇴입니다.',
  ...
  {
    id: 'dk_epc_accessory_01', name: '용의 뼈 전리품', description: '근접 딜러들의 꿈의 장신구입니다.',
  ...
  {
    id: 'dk_epc_shoulders_01', name: '전쟁인도자의 견갑', description: '전사 티어 4 (전쟁인도자) 세트의 어깨 방어구입니다.',
